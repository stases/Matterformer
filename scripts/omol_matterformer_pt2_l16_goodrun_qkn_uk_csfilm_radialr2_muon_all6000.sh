...
export MATTERFORMER_PLATONIC_TRITON_BWD="${MATTERFORMER_PLATONIC_TRITON_BWD:-split}"
...
export RUN_SLUG="${RUN_SLUG:-matterformer-pt2-h1920-l16-ls1e-4-ffn4-actsin-ractgelu-rs2.0-qkn-uk-csFiLM-radialr2-splitbwd-bm16bn32-ema0.99-wd1e-8-lr5e-4-lrmin1e-6-muonffnconv0.02-mwd0-warm2k-auxadamw-fw20-20ep-n12000-flat-maxg999999-platonichead-trunkcompile-skip1000}"
export WANDB_PROJECT="${WANDB_PROJECT:-matterformer_omol_4m}"
export WANDB_GROUP="${WANDB_GROUP:-matterformer_pt2_l16_goodrun_qkn_uk_csfilm_radialr2_splitbwd_muon_warm2k_fw20_n12000}"
