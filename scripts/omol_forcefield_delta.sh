...
echo "triton_bwd_mode:         ${MATTERFORMER_PLATONIC_TRITON_BWD:-auto_default}"
echo "triton_delta_mode:       ${MATTERFORMER_PLATONIC_TRITON_DELTA:-triton_vector_default}"
echo "triton_split_head_dim:   ${MATTERFORMER_PLATONIC_TRITON_SPLIT_HEAD_DIM:-auto_default}"
echo "triton_fwd_num_stages:   ${MATTERFORMER_PLATONIC_TRITON_FWD_NUM_STAGES:-kernel_default}"
echo "triton_bwd_num_stages:   ${MATTERFORMER_PLATONIC_TRITON_BWD_NUM_STAGES:-kernel_default}"
