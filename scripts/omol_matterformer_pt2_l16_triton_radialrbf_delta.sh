#!/bin/bash
# Matterformer PT2 exact-style OMol run with 16-layer tetra trunk and Triton radial RBF bias.

#SBATCH --partition=delta
#SBATCH --account=deltausers
#SBATCH --gres=gpu:1
#SBATCH --job-name=mf_pt2_l16_rbf
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=5-00:00:00
#SBATCH --mem=64G
#SBATCH --output=/home/thadziv/matterformer_jobs/job_outputs/slurm_output_%A_mf_pt2_l16_rbf.out

set -euo pipefail

REPO_ROOT="${REPO_ROOT:-/home/thadziv/GitHub/Matterformer}"

export HYBRID_CONFIG_JSON="${HYBRID_CONFIG_JSON:-$REPO_ROOT/configs/omol/tetra_t_only_h1920_l16_pt2_exact_sin_layerscale_radialrbf.json}"
...
export RUN_SLUG="${RUN_SLUG:-matterformer-pt2-h1920-l16-ls1e-4-ffn2-actsin-ractsin-rs2.0-ema0.99-wd1e-5-lr2.5e-4-40ep-n12000-flat-maxg999999-platonichead-triton-radialrbf8-skip1000}"
export WANDB_PROJECT="${WANDB_PROJECT:-matterformer_omol_4m}"
export WANDB_GROUP="${WANDB_GROUP:-matterformer_pt2_exact_config_l16_maxg999999_platonichead_lr2p5e-4_triton-radialrbf8_skip1000}"
