#!/bin/bash
# Matterformer PT2 exact-style OMol run with a zero-init antisymmetric tetra pair-force residual.

#SBATCH --partition=delta
#SBATCH --account=deltausers
#SBATCH --gres=gpu:1
#SBATCH --job-name=mf_pt2_l16_pair
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=5-00:00:00
#SBATCH --mem=64G
#SBATCH --output=/home/thadziv/matterformer_jobs/job_outputs/slurm_output_%A_mf_pt2_l16_pair.out
...
export RUN_SLUG="${RUN_SLUG:-matterformer-pt2-h1920-l16-ls1e-4-ffn2-actsin-ractsin-rs2.0-ema0.99-wd1e-5-muonffnconv0.01-mwd0-warm5k-auxadamw-40ep-n12000-flat-maxg999999-platonichead-pairforce30-skip1000}"
export WANDB_PROJECT="${WANDB_PROJECT:-matterformer_omol_4m}"
export WANDB_GROUP="${WANDB_GROUP:-matterformer_pt2_l16_platonichead_pairforce30_muonffnconv0p01_mwd0_warm5k_auxadamw_skip1000}"
