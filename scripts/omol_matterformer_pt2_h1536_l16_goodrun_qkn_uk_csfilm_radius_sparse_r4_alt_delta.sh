#!/bin/bash
# Matterformer h1536/n12 good-run variant with alternating global flash and
# radius-sparse eSEN-like local Platonic attention layers.

#SBATCH --partition=delta
#SBATCH --account=deltausers
#SBATCH --gres=gpu:1
#SBATCH --job-name=mf_good_rsparse_r4
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=5-00:00:00
#SBATCH --mem=96G
#SBATCH --output=/home/thadziv/matterformer_jobs/job_outputs/slurm_output_%A_mf_good_rsparse_r4.out

set -euo pipefail

REPO_ROOT="${REPO_ROOT:-/home/thadziv/GitHub/Matterformer}"

export HYBRID_CONFIG_JSON="${HYBRID_CONFIG_JSON:-$REPO_ROOT/configs/omol/tetra_t_only_h1536_l16_pt2_goodrun_qkn_uk_csfilm_radius_sparse_r4_every2.json}"
...
export RUN_SLUG="${RUN_SLUG:-matterformer-pt2-h1536-dpf128-l16-ls1e-4-ffn4-actsin-ractgelu-rs2.0-qkn-uk-csFiLM-flash-rsparseR4alt-ema0.99-wd1e-8-lr5e-4-lrmin1e-6-muonffnconv0.02-mwd0-warm2k-auxadamw-fw20-100ep-n12000-flat-maxg999999-platonichead-trunkcompile-skip1000}"
export WANDB_PROJECT="${WANDB_PROJECT:-matterformer_omol_4m}"
export WANDB_GROUP="${WANDB_GROUP:-matterformer_pt2_h1536_dpf128_l16_goodrun_qkn_uk_csfilm_flash_rsparseR4alt_muon_warm2k_fw20_100ep_n12000}"
