#!/bin/bash
# PT2-parity Matterformer OMol smoke run with five Triton grouped S_g insertions.

#SBATCH --partition=delta
#SBATCH --account=deltausers
#SBATCH --gres=gpu:1
#SBATCH --job-name=mf_pt2_5sg
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=1-00:00:00
#SBATCH --mem=64G
#SBATCH --output=/home/thadziv/matterformer_jobs/job_outputs/slurm_output_%A_mf_pt2_5sg.out
...
export PROFILE_STEPS="${PROFILE_STEPS:-5}"
