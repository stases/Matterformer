...
#SBATCH --gres=gpu:1
#SBATCH --job-name=omol_T_h1008
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=20
#SBATCH --time=5-00:00:00
#SBATCH --mem=192000M
#SBATCH --output=/home/thadziv/matterformer_jobs/job_outputs/slurm_output_%A_omol_T_h1008.out

set -euo pipefail

REPO_ROOT="${REPO_ROOT:-/home/thadziv/GitHub/Matterformer}"
export HYBRID_CONFIG_JSON="${HYBRID_CONFIG_JSON:-$REPO_ROOT/configs/omol/tetra_t_only_h1008_l8_pt2.json}"
export D_MODEL="${D_MODEL:-1008}"
export N_HEADS="${N_HEADS:-36}"
export RUN_SLUG="${RUN_SLUG:-matterformer_omol4m_T_h1008_l8_ffn2_rs2_ema999_w5k_wd1e5}"
