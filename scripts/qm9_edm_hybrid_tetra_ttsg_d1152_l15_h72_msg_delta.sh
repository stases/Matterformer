...
export SAMPLE_BATCH_SIZE="${SAMPLE_BATCH_SIZE:-32}"
export LR="${LR:-2e-4}"
export WARMUP_STEPS="${WARMUP_STEPS:-5000}"
export SKIP_LOSS_THRESHOLD="${SKIP_LOSS_THRESHOLD:-100.0}"
export SKIP_GRAD_NORM_THRESHOLD="${SKIP_GRAD_NORM_THRESHOLD:-20000.0}"
export RUN_SLUG="${RUN_SLUG:-matterformer_qm9_tetra_ttsg_d1152_l15_h72_msg_ptdefaults_b32}"
export WANDB_GROUP="${WANDB_GROUP:-qm9_tetra_ttsg_d1152_l15_h72_msg_ptdefaults_b32}"
