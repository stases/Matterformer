...
export SKIP_LOSS_THRESHOLD="${SKIP_LOSS_THRESHOLD:-1000.0}"
export SKIP_GRAD_NORM_THRESHOLD="${SKIP_GRAD_NORM_THRESHOLD:-20000.0}"
export RUN_SLUG="${RUN_SLUG:-matterformer_qm9_tetra_ttsg_d1152_l15_h72_msg_stage1_b96}"
export WANDB_GROUP="${WANDB_GROUP:-qm9_tetra_ttsg_d1152_l15_h72_msg_stage1_b96}"
