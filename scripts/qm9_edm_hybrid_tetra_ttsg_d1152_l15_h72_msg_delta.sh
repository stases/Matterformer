...
export RUN_SLUG="${RUN_SLUG:-matterformer_qm9_tetra_ttsg_d1152_l15_h72_msg_platonicio_b96}"
export WANDB_GROUP="${WANDB_GROUP:-qm9_tetra_ttsg_d1152_l15_h72_msg_platonicio_b96}"
