...
export RUN_SLUG="${RUN_SLUG:-matterformer_qm9_tetra_t_only_d1152_l14_h72_platonic_match_samplemean_permolrot}"
export WANDB_GROUP="${WANDB_GROUP:-qm9_tetra_t_only_d1152_l14_h72_platonic_match_samplemean_permolrot}"
