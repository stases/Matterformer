...
export EDM_LOSS_REDUCTION="${EDM_LOSS_REDUCTION:-node_mean}"
export ROTATION_AUGMENTATION_MODE="${ROTATION_AUGMENTATION_MODE:-batch}"
export RUN_SLUG="${RUN_SLUG:-matterformer_qm9_tetra_t_only_d1152_l14_h72_platonic_match}"
export WANDB_GROUP="${WANDB_GROUP:-qm9_tetra_t_only_d1152_l14_h72_platonic_match}"
