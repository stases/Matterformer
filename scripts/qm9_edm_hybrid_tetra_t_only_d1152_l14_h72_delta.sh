...
export RUN_SLUG="${RUN_SLUG:-matterformer_qm9_tetra_t_only_d1152_l14_h72_ptdefaults}"
export WANDB_GROUP="${WANDB_GROUP:-qm9_tetra_t_only_d1152_l14_h72_ptdefaults}"
